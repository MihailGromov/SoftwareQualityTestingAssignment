...
namespace SeleniumTests
{
    ...
    public class SeleniumTest5
    {
        ...
        public void SetupTest()
        {
            ...
            baseURL = "http://localhost:51294/WebForm1.aspx";
        ...
        [Test]
        public void TheSeleniumTest5Test()
        {
            ...
            driver.FindElement(By.Id("tbxAge")).SendKeys("17");
            driver.FindElement(By.Id("Button1")).Click();
            Assert.AreEqual("0", driver.FindElement(By.Id("lblResult")).Text);
        }
